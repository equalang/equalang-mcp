...
- “menu.jpg की हिंदी वाली तस्वीर बना दो।”
- “novel.epub का हिंदी में अनुवाद करो।”
...
कुंजी हर मशीन पर एक बार `~/.config/equalang/.env` में भी रखी जा सकती है, जिसे Equalang स्किल भी पढ़ता है:
...
सर्वर पहले अपने एनवायरनमेंट में `EQUALANG_API_KEY` देखता है, और वह न हो तभी यह फ़ाइल पढ़ता है: क्लाइंट कॉन्फ़िग में लिखी कुंजी को प्राथमिकता मिलती है, और यह फ़ाइल हो तो क्लाइंट कॉन्फ़िग में `env` की ज़रूरत नहीं रहती।
