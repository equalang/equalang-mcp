...
- **थोक में टेक्स्ट** - अलग-अलग स्ट्रिंग का उसी क्रम में अनुवाद, या एक लंबा टेक्स्ट (100,000 वर्णों तक) जिसे Equalang ख़ुद वाक्यों पर काटता है
- **100+ भाषाएँ** - टेक्स्ट के लिए 100+ और फ़ाइलों के लिए 12, और स्रोत भाषा न दें तो वह अपने-आप पहचान ली जाती है
...
भाषा कोड `en`, `zh-CN`, `ja` जैसे होते हैं; `list_languages` उन्हें लाइव API से पढ़ता है, इसलिए Equalang जो भाषा जोड़ता है वह बिना अपडेट के उपलब्ध हो जाती है। जॉब में कुछ मिनट लगते हैं - टूल `wait_seconds` तक इंतज़ार करता है (डिफ़ॉल्ट 50 s, अधिकतम 240), फिर `check_job` के लिए एक जॉब id लौटा देता है।
