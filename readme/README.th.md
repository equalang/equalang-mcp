...
หรือจะเก็บคีย์ไว้เครื่องละครั้งใน `~/.config/equalang/.env` ในรูป `EQUALANG_API_KEY=el_your_key` ก็ได้ เมื่อตัวแปรสภาพแวดล้อมของเซิร์ฟเวอร์ไม่มีคีย์ เซิร์ฟเวอร์จะอ่านไฟล์นี้ และสกิลของ Equalang ก็อ่านไฟล์เดียวกัน - คอนฟิกของไคลเอนต์จึงไม่ต้องมี `env`
