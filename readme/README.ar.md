...
| `translate_text` | تترجم نصوصًا منفصلة، بالترتيب - أو نصًا طويلًا واحدًا تقسّمه Equalang بنفسها عند حدود الجمل. |
...
**الصيغ والحدود.** الصيغ المذكورة أعلاه، حتى 100 MB للملف؛ وتقبل `translate_text` حتى 50 نصًا بطول 5,000 حرف (20,000 للاستدعاء الواحد)، أو نصًا واحدًا حتى 100,000.
